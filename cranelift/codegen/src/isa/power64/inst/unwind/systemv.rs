//! Unwind information for System V ABI (Power64).

use crate::isa::power64::inst::regs;
use crate::isa::unwind::systemv::RegisterMappingError;
use crate::machinst::Reg;
use gimli::{write::CommonInformationEntry, Encoding, Format, Register};
use regalloc2::RegClass;

/// Creates a new power64 common information entry (CIE).
...
mod tests {
    ...
    #[test]
    fn test_simple_func() {
        let isa = lookup(triple!("power64"))
            .expect("expect power64 ISA")
